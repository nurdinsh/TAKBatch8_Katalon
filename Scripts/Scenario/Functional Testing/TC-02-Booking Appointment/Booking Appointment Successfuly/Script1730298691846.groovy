...
WebUI.callTestCase(findTestCase('Blocks/Make Appointment'), [('facility') : facility, ('visit_date') : visit_date, ('comment') : comment
        , ('healthcare_program') : healthcare_program, ('hospital_readmission') : hospital_readmission], FailureHandling.STOP_ON_FAILURE)
