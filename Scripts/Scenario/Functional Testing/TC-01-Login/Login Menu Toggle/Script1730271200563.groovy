...
'Step 4'
if (testType == 'P') {
    WebUI.verifyElementVisible(findTestObject('Object Repository/TC-01-Login/h1_cura healthcare service'))
} else {
    WebUI.verifyElementVisible(findTestObject('TC-01-Login/msg_login failed'), FailureHandling.STOP_ON_FAILURE)
}
